            ...
            new Collections.AnnotationTypes().fetch({
                success: (collection, response, options) => {
                    ...
                    return this.projectAnnotationTypeIDs.fetch((data) => {
                        ...
                        this.set('annotationtypes', new Collections.AnnotationTypes(collection.filter(function (model) {
            ...
            new Collections.Users().fetch({
                success: (collection) => {
                    ...
                    return this.projectUserIDs.fetch((data) => {
                        ...
                        this.set('members', new Collections.Users(collection.filter((model) => {
                            return data.indexOf(model.id) > -1;
                        })));

...
// ## Pagination
export class Pagination extends BaseView {
  // ### Initialize
  constructor(private options?: any) {
    ...
    const currentPage = (this.options.start != null) && this.options.start > 0 ? (this.options.start / this.options.rowCount) + 1 : 1;
  ...
  setCurrentPage(pageNumber, silent = false) {
    var direction;
    if (!this.options.triggerPagenumber) {

...
export class SuperTinyEditor extends BaseView {
  options
  autoScroll
  $currentHeader
  iframeDocument
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .ste-iframe-body.wrap {
                white-space: normal;
              }

              .ste-iframe-body sup[data-marker] {
                color: #888;
          ...
          <body class='ste-iframe-body' spellcheck='false' contenteditable='true'>
            ${this.model.get(this.options.htmlAttribute)}
          </body>
        </html>`);

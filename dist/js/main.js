...
buf.push("<li> <label" + (jade.attrs({ 'title':(metadata.description) }, {"title":true})) + ">" + (jade.escape(null == (jade.interp = metadata.name) ? "" : jade.interp)) + "</label><input" + (jade.attrs({ 'type':("text"), 'name':('metadata.'+metadata.name), 'value':(model.get('metadata')[metadata.name]) }, {"type":true,"name":true,"value":true})) + "/><x></x></li>");
    }
...
{
buf.push("<div class=\"cell span1\"><ul class=\"horizontal menu\"><li data-key=\"newentry\">New entry</li><li data-key=\"editselection\">Edit metadata</li></ul></div><div class=\"cell span1 alignright\"><ul class=\"horizontal menu\"><li data-key=\"publish\">Publish draft</li></ul></div>");
}
...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // define(factory);
        define('faceted-search',['jquery', 'underscore', 'backbone'], factory);
  ...
  define('views/project/main',['require','hilib/functions/general','config','hilib/managers/token','models/currentUser','models/entry','collections/projects','views/base','faceted-search','hilib/views/modal/main','views/project/editselection','tpls'],function(require) {
    ...
    return ProjectSearch = (function(_super) {
      ...
      ProjectSearch.prototype.changeCurrentEntry = function(ev) {
        var entryID, placeholder;
        placeholder = this.el.querySelector('.editselection-placeholder');
        if ((placeholder != null) && placeholder.style.display === 'block') {
          return;
        }
      ...
      ProjectSearch.prototype.destroy = function() {
        this.facetedSearch.remove();
        return this.remove();
      };

      ProjectSearch.prototype.activatePublishDraftButton = function() {
        var busyText, button;
      ...
      ProjectSearch.prototype.deactivatePublishDraftButton = function() {
        var button;
        button = this.el.querySelector('li[data-key="publish"]');
      ...
      ProjectSearch.prototype.publishDraft = function(ev) {
        var _this = this;
        this.activatePublishDraftButton();
        return this.project.publishDraft(function() {
          return _this.deactivatePublishDraftButton();
        });
      };

      ProjectSearch.prototype.pollDraft = function() {
        var locationUrl,
          _this = this;
        locationUrl = localStorage.getItem('publishDraftLocation');
        if (locationUrl != null) {
          this.activatePublishDraftButton();
          return this.project.pollDraft(locationUrl, function() {
            return _this.deactivatePublishDraftButton();
          });
        }
      };
  ...
  define('views/project/settings',['require','config','hilib/managers/async','hilib/managers/ajax','hilib/managers/token','entry.metadata','views/base','hilib/views/form/editablelist/main','hilib/views/form/combolist/main','hilib/views/form/main','hilib/views/modal/main','models/project/statistics','models/project/settings','models/user','models/project/annotationtype','collections/projects','collections/project/annotationtypes','collections/project/users','collections/users','project.user.ids','tpls'],function(require) {
    ...
    return ProjectSettings = (function(_super) {
      ...
      ProjectSettings.prototype.renderTabs = function() {
        ...
        return this.$('div[data-tab="metadata-entries"] .entrylist').append(EntryMetadataList.el);
      };
      ...
      ProjectSettings.prototype.events = {
        ...
        'change .setnames form input[type="text"]': function(ev) {
          return this.$('.setnames form input[type="submit"]').removeClass('inactive');
        }
      };

      ProjectSettings.prototype.submitSetCustomNames = function(ev) {
        var input, _i, _len, _ref1;
        ev.preventDefault();
        _ref1 = this.el.querySelectorAll('.setnames form input[type="text"]');
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          input = _ref1[_i];
          this.model.set(input.name, input.value);
        }
        return this.saveSettings(ev);
      };
...
(function() {
  ...
  define('routers/main',['require','backbone','hilib/managers/view','hilib/managers/history','hilib/mixins/pubsub','hilib/functions/general','collections/projects','views/login','views/project/main','views/project/settings','views/project/history','views/entry/main','views/ui/header'],function(require) {
    ...
    return MainRouter = (function(_super) {
      ...
      MainRouter.prototype.projectMain = function(name) {

...
(function() {
  ...
  define('models/project/annotation.type',['require','models/base'],function(require) {
...
(function() {
  ...
  define('collections/project/annotation.types',['require','config','collections/base','models/project/annotation.type'],function(require) {
...
(function() {
  ...
  define('collections/projects',['require','config','collections/base','models/project'],function(require) {
  ...
  define('views/facet',['require','views/base','text!html/facet.html'],function(require) {
    ...
    return Facet = (function(_super) {
      ...
      Facet.prototype.update = function(newOptions) {
        return console.log('newOptions', newOptions);
      };
...
(function() {
  ...
  define('views/facets/list.options',['require','helpers/general','views/base','models/list','text!html/facet/list.options.html'],function(require) {
...
(function() {
  ...
  define('main',['require','config','facetviewmap','models/main','views/base','views/search','views/facets/list','views/facets/boolean','views/facets/date','text!html/faceted-search.html'],function(require) {
...
define('text!html/ui/settings.submenu.html',[],function () { return '<div class="row span7"><div class="cell span3 left"><ul class="horizontal menu"><li data-key="save" class="inactive">Saved</li></ul></div><div class="cell span2 aligncenter"><ul class="horizontal menu"></ul></div><div class="cell span2 alignright"><ul class="horizontal menu"></ul></div></div>';});
...
(function() {
  ...
  define('collections/project/users',['require','config','models/state','collections/base'],function(require) {
    var Collections, Models, ProjectUsers, config, _ref;
    config = require('config');
    Models = {
      state: require('models/state')
    };
    ...
    return ProjectUsers = (function(_super) {
      ...
      ProjectUsers.prototype.url = function() {
        var id;
        id = Models.state.get('currentProject').id;
        return "" + config.baseUrl + "projects/" + id + "/users";
      };
...
(function() {
  ...
  define('collections/project/history',['require','config','models/state','collections/base'],function(require) {
...
(function() {
  ...
  define('views/ui/entry.submenu',['require','views/base','text!html/ui/entry.submenu.html'],function(require) {
...
(function() {
  ...
  define('views/entry/preview',['require','helpers/general','views/base','views/entry/tooltip.add.annotation','views/entry/tooltip.edit.annotation','text!html/entry/preview.html'],function(require) {
...
define('text!html/entry/main.html',[],function () { return '<div class="submenu"><div class="row span7"><div class="cell span3 left"><ul class="horizontal menu"><li data-key="previous" class="arrowleft">Previous entry</li><li data-key="next" class="arrowright">Next entry</li><li data-key="print">Print</li><li data-key="facsimiles" class="arrowdown">Facsimiles<ul class="vertical menu"><% facsimiles.each(function(facs) { %><li data-key="facsimile" data-value="<%= facs.id %>"><%= facs.get(\'name\') %></li><% }); %></ul></li></ul></div><div class="cell span2"><ul class="horizontal menu"><li data-key="save">Save</li><li data-key="layer" class="arrowdown">Layer<ul class="vertical menu"><% transcriptions.each(function(trans) { %><li data-key="transcription" data-value="<%= trans.id %>"><%= trans.get(\'textLayer\') %></li><% }); %></ul></li><li data-key="metadata">Metadata</li></ul></div><div class="cell span2 alignright"><ul class="horizontal menu"><li data-key="preview">Preview full screen</li></ul></div></div></div><div class="row span7 container"><div class="cell span3"><div class="left"><% if (facsimiles.length) { %><iframe id="viewer_iframe" name="viewer_iframe" scrolling="no" width="100%" height="800px" frameborder="0"></iframe><% } %></div></div><div class="cell span2"><div class="middle"><div class="transcription"></div><div class="annotation"></div><div class="annotationmetadata"></div></div></div><div class="cell span2"><div class="right"></div></div></div>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/entry/main',['require','backbone','helpers/general','helpers2/string','helpers/jquery.mixin','managers2/async','models/state','models/entry','views/base','views/ui/entry.submenu','views/entry/preview','views2/supertinyeditor/supertinyeditor','views/entry/metadata.annotation','text!html/entry/main.html'],function(require) {
...
define('text!html/debug.html',[],function () { return '<ul><li class="current-user">Current User</li><li class="current-project">Current Project</li><li class="state">State</li></ul>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/debug',['require','models/state','models/currentUser','views/base','text!html/debug.html'],function(require) {
...
(function() {
  define('app',['require','backbone','routers/main','models/currentUser','models/state','views/ui/header','views/debug'],function(require) {
